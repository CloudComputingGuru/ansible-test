...
class Ec2Inventory(object):
    ...
    def read_settings(self):
        ...
        self.iam_role = os.environ["IAM_ROLE"]
        self.iam_external_id = os.environ["IAM_ROLE_EXTERNAL_ID"]
    ...
    def connect_to_aws(self, module, region):
        ...
        if self.iam_role:
            ...
            role = sts_client.assume_role(RoleArn=self.iam_role, RoleSessionName='ansible_dynamic_inventory', ExternalId=self.iam_external_id)
            connect_args['aws_access_key_id'] = role["Credentials"]["AccessKeyId"]
            connect_args['aws_secret_access_key'] = role["Credentials"]["SecretAccessKey"]
            connect_args['security_token'] = role["Credentials"]["SessionToken"]
